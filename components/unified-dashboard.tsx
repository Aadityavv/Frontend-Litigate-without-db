...
import CaseDetailView from "@/components/CaseDetailView"; // Assuming you have this component
import {
  Grid,
  FolderOpen,
  Search,
          ...
          {[{
            ...
            <li key={section}>
              <Button
                ...
                className={`w-full flex items-center justify-start pl-4 pr-2 py-3 text-left rounded-lg ${activeSection === section
                  ? "bg-gray-100 text-black hover:bg-gray-100"
                  : "bg-white text-black hover:bg-gray-100"
                  }`}
              >
