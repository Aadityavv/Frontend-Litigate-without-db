...
export const fetchCases = async () => {
  ...
  try {
    const response = await fetch(`https://litigate-backend.onrender.com/api/cases?lawyerId=${lawyerId}`, {
      headers: {
        ...getAuthHeaders(),
      },
    });
...
export const fetchCaseById = async (caseId) => {
  const lawyerId = getLawyerId();
  try {
    const response = await fetch(`https://litigate-backend.onrender.com/caseDetails/?lawyerId=${lawyerId}&caseId=${caseId}`, {
      headers: {
        ...getAuthHeaders(),
      },
    });
...
export const deleteCase = async (caseId) => {
  ...
  try {
    ...
    const response = await fetch(
      `https://litigate-backend.onrender.com/delete/case/?lawyerId=${lawyerId}&caseId=${caseId}`,
      {
...
export const fetchStats = async () => {
  const lawyerId = getLawyerId();
  try {
    const response = await fetch(`https://litigate-backend.onrender.com/api/stats?lawyerId=${lawyerId}`, {
...
export const fetchStatDetails = async (type) => {
  const lawyerId = getLawyerId();
  try {
    const response = await fetch(`https://litigate-backend.onrender.com/api/stats/details?lawyerId=${lawyerId}&type=${type}`, {
      headers: { ...getAuthHeaders() },
    });
